		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Scan digital receipts (Scanner reçus digitaux)",
									"targetURL": "#comvesizfafidgtrcpt-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comvesizfafidgtrcpt-display": {
								"semanticObject": "comvesizfafidgtrcpt",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.vesi.zfafidgtrcpt",
									"url": sap.ui.require.toUrl("com/vesi/zfafidgtrcpt")
								}
							}
						}
					}
